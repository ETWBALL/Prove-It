...
export type OAuthAccountWhereInput = {
  ...
  privateId?: Prisma.IntFilter<"OAuthAccount"> | number
  privateUserId?: Prisma.IntFilter<"OAuthAccount"> | number
  providerName?: Prisma.StringFilter<"OAuthAccount"> | string
...
export type OAuthAccountWhereUniqueInput = Prisma.AtLeast<{
  ...
  accessToken?: string
  refreshToken?: string
  providerName_providerId?: Prisma.OAuthAccountProviderNameProviderIdCompoundUniqueInput
  AND?: Prisma.OAuthAccountWhereInput | Prisma.OAuthAccountWhereInput[]
  OR?: Prisma.OAuthAccountWhereInput[]
  NOT?: Prisma.OAuthAccountWhereInput | Prisma.OAuthAccountWhereInput[]
  privateUserId?: Prisma.IntFilter<"OAuthAccount"> | number
  ...
  createdAt?: Prisma.DateTimeFilter<"OAuthAccount"> | Date | string
  user?: Prisma.XOR<Prisma.UserScalarRelationFilter, Prisma.UserWhereInput>
}, "privateId" | "accessToken" | "refreshToken" | "providerName_providerId">
...
export type OAuthAccountScalarWhereWithAggregatesInput = {
  ...
  privateId?: Prisma.IntWithAggregatesFilter<"OAuthAccount"> | number
  privateUserId?: Prisma.IntWithAggregatesFilter<"OAuthAccount"> | number
  providerName?: Prisma.StringWithAggregatesFilter<"OAuthAccount"> | string
...
export type OAuthAccountProviderNameProviderIdCompoundUniqueInput = {
  providerName: string
  providerId: string
}
...
export type OAuthAccountOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"privateId" | "privateUserId" | "providerName" | "providerId" | "accessToken" | "refreshToken" | "createdAt", ExtArgs["result"]["oAuthAccount"]>
...
export interface OAuthAccountDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const oAuthAccountWithPrivateIdOnly = await prisma.oAuthAccount.findMany({ select: { privateId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OAuthAccounts and only return the `privateId`
   * const oAuthAccountWithPrivateIdOnly = await prisma.oAuthAccount.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more OAuthAccounts and only return the `privateId`
   * const oAuthAccountWithPrivateIdOnly = await prisma.oAuthAccount.updateManyAndReturn({
   *   select: { privateId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface OAuthAccountFieldRefs {
  readonly privateId: Prisma.FieldRef<"OAuthAccount", 'Int'>
  readonly privateUserId: Prisma.FieldRef<"OAuthAccount", 'Int'>
  readonly providerName: Prisma.FieldRef<"OAuthAccount", 'String'>
